...
async function mint(rpc, private_key, gasPrice, maxFeePerGas, maxPriorityFeePerGas, data) {
...
async function main() {
    ...
    await mint(_rpc, _private_key, _gasPrice, _maxFeePerGas, _maxPriorityFeePerGas, _data);
}
